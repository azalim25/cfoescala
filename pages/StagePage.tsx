            ...
            <MainLayout.Content>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl p-4 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-wrap items-center justify-between gap-4 mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="font-bold text-lg text-slate-800 dark:text-slate-100 capitalize">Estágios de {currentMonthName}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {locations.map(loc => {
                        const locStages = stages.filter(s => s.location === loc);
                        return (
